...
The chunks of story text that you read are called **chunks**. Chunks are self-contained pieces of text that contain zero or more _links_ to other chunks. Storious is best written with chunks that live in their own text files. Trying to combine multiple chunks in a file won't work: they rely on YAML frontmatter, of which there can only be one section of in a file.
...
The first link would look for a chunk that is called `youre wild` (space inclusive: `youre-wild` would be a different chunk), and the second would look for a chunk named `Nah Just a regular Tuesday` (not interchangeable with `nah just a regular tuesday`).

Links will filter out any punctuation, but they won't normalise case. Unicode characters (`å`, `も`, `ж`, you get the idea) will be left in, provided the system / locale supports it.

Links can be masked, like in the case of `youre wild`, where

> If you say youre wild, turn to page 24.

would not be a good look. The format of a masked link is `[[ DESTINATION | MASK ]]`.
...
<!-- prettier-ignore -->
Did you mean to have something here? Check that your
chunks are named right and that your links point to them.
Remember, links are case and space sensitive!
...
![](https://mermaid.-IGNoZWNrZG9vclxuICBnbyAtLi0-IGNoZWNrd2luZG93XG4gIGdvIC0tPiBjaGVja2JveFxuICBnbyAtLi0-IGdldGhvdGRvZ1xuICBnbyAtLi0-IG1vdmVib3hcbiAgZ28gLS0-IHVubG9ja2Rvb3JcblxuICBjaGVja2Rvb3IgLS0-IGtub3dzbG9ja2VkIC0uLT4gZ29cbiAgY2hlY2t3aW5kb3cgLS0-IGtub3dzbW9uc3RlciAtLi0-IGdvXG4gIGNoZWNrYm94ICAtLT4gaGFza2V5ICAtLT4gZ29cbiAgbW92ZWJveCAtLT4ga25vd3NtYXDjgIBcbiAgZ2V0aG90ZG9nIC0uLT4gZWF0aG90ZG9nIC0tPiBpbnRlcmlt44CAXG4gIGdldGhvdGRvZyAtLi0-IGdvXG4gIGtub3dzbWFwIC0uLT4gZ29cbiAgaW50ZXJpbSAtLi0-IGdvXG5cbiAgdW5sb2NrZG9vciAtLiBkb2Vzbid0IGtub3cgYWJvdXQgdGhlIG1vbnN0ZXIgLi0-IGJhZGVuZGluZ1xuICB1bmxvY2tkb29yIC0uIG9ubHkga25vd3MgYWJvdXQgdGhlIG1vbnN0ZXIgLi0-IGJhZGVuZGluZ1xuICB1bmxvY2tkb29yIC0uIGtub3dzIGFib3V0IHRoZSBtb25zdGVyIEFORCBoYXMgYSBob3Rkb2cgLi0-IGdpdmVob3Rkb2cgLS0-)
...
The amount of fiction in a piece of interactive fiction quickly balloons: a scenario that was described start-to-finish in less than 100 words quickly becomes a tangled mess of "what-ifs" and "if-thens". This is, after all, why the medium works so well on a computer: there's someone or something else managing all the moving parts of a scene.
...
Planned but not critical is the feature to split stories up across volumes. Amazon won't print your 9000 page magnum opus, but they will let you offer readers / your future self those 9000 pages in [11ish 828-page instalments](https://kdp.amazon.com/en_US/help/topic/G201834340), for example.
...
Later, the reader may come across something like:

> If you have a box of cookies, you can share with the little girl.
>
> Remove the box of cookies from your inventory and turn to page 64.

> If you do not have any cookies, turn to page 53.

Variables can be defined in a chunk's front matter.
